...
d.Sonra karşınıza çıkan ilk sonucun resmine tıkla
        ...
        // List<WebElement> urunSayisiList=driver.findElements(By.className("a-section aok-relative s-image-fixed-height"));
         System.out.println("Goruntulenen Urun Sayisi : "+urunSayisiList.size());
